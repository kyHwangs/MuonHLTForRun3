...
def enableDoubletRecoveryInIOFromL2(process):
    ...
    #seedingLayers = cms.InputTag( "" ), ## HERE
    #trackingRegions = cms.InputTag( "" ), ## HERE
    #trackingRegionsSeedingLayers = cms.InputTag( "hltIter3IterL3MuonPixelLayersAndRegions" ), ## HERE
